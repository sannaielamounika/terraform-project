...
module "s3" {
  ...
  kms_master_key_arn = module.kms["test_master"].key_arn
}
...
module "secrets_manager" {
  ...
  description             = each.value.description
  kms_key_id              = module.kms["test_master"].key_arn
...
module "rds" {
  ...
  kms_key_arn             = module.kms["test_master"].key_arn
}
